			...
			<div class="panel-body">
				  <table class="table table-striped table-responsive" id="dataTable">
				    ...
				    <?php 
				    	$total=0;
				    	$no=1;
				    	$sql=$koneksi->query("SELECT*FROM tb_transaksi WHERE jenis='keluar' ");
				    ...
				    ?>
				      <tr>
				        ...
				        <td>
				        	<a id="edit_data" data-id="<?php echo $data['kode']; ?>" data-ket="<?php echo $data['keterangan']; ?>" data-tgl="<?php echo $data['tgl']; ?>" data-jml="<?php echo $data['keluar']; ?>" data-toggle="modal" data-target="#edit" class="btn btn-warning">Edit</a>
				        	<a onclick="return confirm('Yakin mau dihapus?')" href="?page=keluar&aksi=hapus&id=<?php echo $data['kode']; ?>" class="btn btn-danger">Hapus</a>
				        </td>
				      </tr>
				    <?php 
				    ...
				    <div class="modal-content">
				    	...
				    	<?php 
							if (isset($_POST['simpan'])) {
								...
								VALUES('$kode','$ket','$tgl',0,'keluar','$jml')")or die(mysqli_error($koneksi));
				    	...
				    	<?php 
							if (isset($_POST['ubah'])) {
								...
								$sql=$koneksi->query("UPDATE tb_transaksi SET
									keterangan='$ket',tgl='$tgl',jumlah=0,jenis='keluar',keluar='$jml' WHERE kode='$kode' ")or die(mysqli_error($koneksi));
